...
public class AdminController {
    ...
    @PostMapping("/promote/inactive")
    // koristim DemotionRequest zato što on ima samo username, a PromotionRequest ima i username i smjenu, stoga to ne funkcionira
    // pa da se smanji količina koda i klasa
    public ResponseEntity<PromotionResponse> promotionInactive(@RequestBody DemotionRequest request) {

        if (request != null && request.getUsername() != null) {
            User promotedUser = promotionService.promoteInactive(request.getUsername());
