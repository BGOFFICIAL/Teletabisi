...
const Admin = () => {
    ...
    const [roles, setRoles] = useLocalState("", "roles");
    ...
    const handleAktiviranje = async (e) => {
        e.preventDefault();
        ...
        if (usernameA !== '' ) {
            ...
            try {
                ...
                const response = await
                    fetch("http://localhost:8080/api/v1/func/administration/promote/inactive", {
                        headers: {
                            "Content-Type": "application/json",
                            'Authorization': `Bearer ${jwt}`,
            ...
            <Card className='text-center'>
                ...
                <Card.Body>
                    ...
                    <Form className='no-gutters ' onSubmit={handleAdd}>
                        ...
                        <Row>
                            <Col>
                                <Button type='submit' style={{ marginRight: '0.5rem' }}>Dodaj kao zaposlenika</Button>
